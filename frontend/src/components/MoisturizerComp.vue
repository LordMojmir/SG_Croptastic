...
<template>
  <eox-map
      ...
      :layers="[
        { type: 'Tile', properties: { id: 'Ndvi' }, source: { type: 'TileWMS', url: 'https://creodias.sentinel-hub.com/ogc/wms/afdf0697-ed64-430a-91c3-74b1749cf1f1', params: { LAYERS: 'NDVI', TIME: '2022-12-05' } } },
